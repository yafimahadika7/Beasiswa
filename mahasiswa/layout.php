...
if ($q1 !== false) {
    $row = $q1->fetch_assoc();
    $notif_count = isset($row['jml']) ? $row['jml'] : 0;
}

/* ==========================================================
   AMBIL DAFTAR PESAN (SEMUA)
========================================================== */
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center ms-auto">
                ...
                <span class="text-white">
                    Halo, <?php echo isset($_SESSION['nama']) ? $_SESSION['nama'] : "Mahasiswa"; ?>
                </span>
    ...
    <script>
        ...
        // Modal dibuka → tandai notifikasi dibaca
