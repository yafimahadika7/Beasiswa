    ...
    <div class="wrapper">
        ...
        <div id="sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="beasiswa.php"
                        class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'beasiswa.php' ? 'active' : '' ?>">
                        <i class="bi bi-award me-2"></i> Data Beasiswa
                    </a>
                </li>
                ...
                <li>
                    <a href="pendaftaran.php"
                        ...
                        <i class="bi bi-journal-check me-2"></i> Pendaftaran
                    </a>
                </li>

                <li>
                    <a href="penerima_beasiswa.php"
                        class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'penerima_beasiswa.php' ? 'active' : '' ?>">
                        <i class="bi bi-trophy me-2"></i> Penerima Beasiswa
                    </a>
                </li>
